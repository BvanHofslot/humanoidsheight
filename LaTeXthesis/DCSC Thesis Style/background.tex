...
%TODO
\todo{Incorporate somewhere the virtual point foot and virtual leg}

%leg modeling
\subsection{Modeling of the Leg}
...
\begin{itemize}
	...
	\item A nonlinear model with prismatic joint \cite{pratt2007derivation}
\end{itemize}
