...
\newcommand{\x}{\lsymb{$x$}{CoM state in Eucledian space}}
\newcommand{\y}{\lsymb{$y$}{CoM state in Eucledian space}}
\newcommand{\z}{\lsymb{$z$}{CoM state in Eucledian space}}
\newcommand{\rcmpd}{r_{cmp,d}}
\newcommand{\rcmpr}{r_{cmp,r}}
\newcommand{\rcmp}{r_{cmp}}
\newcommand{\rcop}{r_{cop}}
\newcommand{\rcopd}{r_{cop,d}}
