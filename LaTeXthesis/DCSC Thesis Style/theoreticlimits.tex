...
\end{equation}
If the input torque $\tau_y$ would be used in a ballistic trajectory in any of the points presented in this chapter, the \ac{GRF} would become parallel to the ground plane. This would require infinite ground friction, which is in practice never the case.
