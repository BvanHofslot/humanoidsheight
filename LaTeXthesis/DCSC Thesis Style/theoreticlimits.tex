...
\end{empheq}
where $\xcpunif$ is the first bound on the unilateral contact constrained capture region. In other words: when the point-mass approaching the base is infinitely close to the base, an infinite vertical impact is needed to stop the horizontal motion.
